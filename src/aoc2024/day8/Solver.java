...
public class Solver {
    ...
    public static void main(String[] args) {
        ...
        InputProcessor processor = new InputProcessor("src/aoc2024/day8/input.txt");
        ...
        System.out.println("Star 1 solution: " + result.star(false));
        System.out.println("Star 2 solution: " + result.star(true));
    }
}
